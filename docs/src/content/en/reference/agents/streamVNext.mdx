...
<PropertiesTable
  content={[
    {
      name: "messages",
      type: "string | string[] | MessageInput[] | CoreMessage[] | AiMessageType[] | UIMessageWithMetadata[]",
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      deprecated:
        "Use `memory.options` instead. Configuration options for memory management.",
    },
    {
      name: "onFinish",
    ...
    },
    {
      ...
      isOptional: true,
      deprecated:
        "Use `memory.resource` instead. Identifier for the user or resource interacting with the agent. Must be provided if threadId is provided.",
    },
    {
      name: "telemetry",
    ...
    },
    {
      ...
      isOptional: true,
      deprecated:
        "Use `memory.thread` instead. Identifier for the conversation thread. Allows for maintaining context across multiple interactions. Must be provided if resourceId is provided.",
    },
    {
      name: "toolChoice",
...
The default 'mastra' format returns a [`MastraModelOutput`](./streamVNextTypes/MastraModelOutput)


```typescript
const stream = await agent.streamVNext("Hello");

// Stream in Mastra format
...
The 'aisdk' format returns an [`AISDKV5OutputStream`](./streamVNextTypes/AISDKV5OutputStream)
...
- `stream.object` - JSON object validated against the provided 'output' schema
